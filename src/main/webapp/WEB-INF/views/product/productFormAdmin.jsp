...
<body>
	...
	<%-- 						<option value="<c:out value="${item.ifmmSeq}"/>"
					...
					<c:out value="${item.ifmmNickname}" /> --%>
						...
						<input type="text" name="shMemberValue" id="shMemberValue" placeholder="판매자검색" value="<c:out value="${vo.shMemberValue}"/>">
						<button type="button" name="search" id="ifmmSeq">Search</button>
